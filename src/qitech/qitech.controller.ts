...
export class QitechController {
  ...
  @Post("/debt")
  public async creatDebt(@Body() createDebtDto: object) {
    ...
    const qitechResponse = await qitech_wrapper.debt.post(createDebtDto);
    return qitechResponse;
    // return this.qitechService.createDebt(createDebtDto);
  }
}
